...
export const OrderSchema = z.object({
    ...
    email:z.email(),
    contact_number: z.string().min(10,'Contact Number must be 10 digits').regex(/^\d{10}$/, 'Invalid mobile number...!!!'),
    shipping_address: z.string().min(3, 'Address must be at least 3 characters').max(100, 'Address must be at maximum 100 characters'),
